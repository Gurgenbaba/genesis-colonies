"""Defense unlock prerequisites (buildings + research)."""
...
def check_defense_requirements(
    defense_key: str,
    *,
    ...
    if not spec:
        return False, ["defense_detail_not_found"]
...
def requirements_summary_for_client(
    ...
    *,
    ...
    ok, missing = check_defense_requirements(
