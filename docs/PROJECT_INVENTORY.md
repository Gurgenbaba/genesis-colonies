...
**Stand:** v0.5.9.83 (2026-08-01) — Alliance MVP complete (GC-AL-MVP-09); Spieler-Meilenstein **v0.9 Alpha**; siehe [BALANCE_ANCHORS.md](BALANCE_ANCHORS.md) für Economy-Anker.  
