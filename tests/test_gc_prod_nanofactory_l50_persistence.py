"""Regression: nanofactory costs are no longer bounded by signed i64."""

from __future__ import annotations


def test_nanofactory_l49_l50_crosses_raw_i64_boundary_without_live_clamp():
