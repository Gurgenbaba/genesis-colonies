...
CONTAINER_IMAGES: Dict[str, str] = {
    "container_basic": "img/lootboxes/Basic_Container.webp",
    "container_rare": "img/lootboxes/Rare_Container.webp",
    "container_epic": "img/lootboxes/Epic_Container.webp",
    "container_relic": "img/lootboxes/Relic_Container.webp",
    "container_wreckage": "img/lootboxes/Wreckage_Container.webp",
    "container_research_cache": "img/lootboxes/Research_Cache.webp",
    "container_military_cache": "img/lootboxes/Military_Cache.webp",
    "container_event_special": "img/lootboxes/Event_Container.webp",
    "container_mythic": "img/lootboxes/Epic_Container.webp",
    "container_ancient_relic": "img/lootboxes/Relic_Container.webp",
    "container_void_artifact": "img/lootboxes/Event_Container.webp",
}

# Shared Genesis Relic art for inventory boosters (Battle Pass / Inventory / Shop preview).
PASS_BOOSTER_IMAGES: Dict[str, str] = {
    "build": "img/pass/build_boost.webp",
    "research": "img/pass/research_booster.webp",
    "production": "img/pass/prod_boost.webp",
}

# All keys that may be stored in player_inventory_items or granted by admin.
ITEM_CATALOG: Dict[str, Dict[str, Any]] = {
    # --- Containers ---
    "container_basic": {"item_type": "container", "category": "container", "rarity": "common", "name_key": "inv_container_basic", "icon": "📦", "image": "img/lootboxes/Basic_Container.webp"},
    "container_rare": {"item_type": "container", "category": "container", "rarity": "uncommon", "name_key": "inv_container_rare", "icon": "🎁", "image": "img/lootboxes/Rare_Container.webp"},
    "container_epic": {"item_type": "container", "category": "container", "rarity": "epic", "name_key": "inv_container_epic", "icon": "💎", "image": "img/lootboxes/Epic_Container.webp"},
    "container_relic": {"item_type": "container", "category": "container", "rarity": "legendary", "name_key": "inv_container_relic", "icon": "🏺", "image": "img/lootboxes/Relic_Container.webp"},
    "container_wreckage": {"item_type": "container", "category": "container", "rarity": "uncommon", "name_key": "inv_container_wreckage", "icon": "🛸", "image": "img/lootboxes/Wreckage_Container.webp"},
    "container_research_cache": {"item_type": "container", "category": "container", "rarity": "rare", "name_key": "inv_container_research_cache", "icon": "🔬", "image": "img/lootboxes/Research_Cache.webp"},
    "container_military_cache": {"item_type": "container", "category": "container", "rarity": "rare", "name_key": "inv_container_military_cache", "icon": "⚔️", "image": "img/lootboxes/Military_Cache.webp"},
    "container_event_special": {"item_type": "container", "category": "container", "rarity": "epic", "name_key": "inv_container_event_special", "icon": "✨", "image": "img/lootboxes/Event_Container.webp"},
    "container_mythic": {"item_type": "container", "category": "container", "rarity": "legendary", "name_key": "inv_container_mythic", "icon": "🌟", "image": "img/lootboxes/Epic_Container.webp"},
    "container_ancient_relic": {"item_type": "container", "category": "container", "rarity": "legendary", "name_key": "inv_container_ancient_relic", "icon": "🏺", "image": "img/lootboxes/Relic_Container.webp"},
    "container_void_artifact": {"item_type": "container", "category": "container", "rarity": "legendary", "name_key": "inv_container_void_artifact", "icon": "🕳️", "image": "img/lootboxes/Event_Container.webp"},
    ...
    "fragment_dna_common": {"item_type": "fragment", "category": "planet_evolution", "rarity": "common", "name_key": "inv_fragment_dna_common", "icon": "🧬", "image": "img/collectibles/fragment_dna_common.webp"},
    "fragment_dna_rare": {"item_type": "fragment", "category": "planet_evolution", "rarity": "rare", "name_key": "inv_fragment_dna_rare", "icon": "🧬", "image": "img/collectibles/fragment_dna_rare.webp"},
    "fragment_dna_epic": {"item_type": "fragment", "category": "planet_evolution", "rarity": "epic", "name_key": "inv_fragment_dna_epic", "icon": "🧬", "image": "img/collectibles/fragment_dna_epic.webp"},
    "fragment_artifact_alpha": {"item_type": "fragment", "category": "research", "rarity": "rare", "name_key": "inv_fragment_artifact_alpha", "icon": "🧩", "image": "img/collectibles/fragment_artifact_alpha.webp"},
    "artifact_core_fragment": {"item_type": "fragment", "category": "research", "rarity": "legendary", "name_key": "inv_artifact_core_fragment", "icon": "🧩"},
    "fragment_alien": {"item_type": "fragment", "category": "expedition", "rarity": "rare", "name_key": "inv_fragment_alien", "icon": "👽", "image": "img/collectibles/fragment_alien.webp"},
    ...
    "fragment_wreck_reactor": {"item_type": "fragment", "category": "expedition", "rarity": "uncommon", "name_key": "inv_fragment_wreck_reactor", "icon": "🔩", "image": "img/collectibles/fragment_wreck_reactor.webp"},
    "fragment_wreck_hull": {"item_type": "fragment", "category": "expedition", "rarity": "uncommon", "name_key": "inv_fragment_wreck_hull", "icon": "🛡️", "image": "img/collectibles/fragment_wreck_hull.webp"},
    ...
    "research_data_energy": {
        ...
        "icon": "💾",
        "image": "img/collectibles/research_data_energy.webp",
        "use_role": "usable",
    ...
    "research_data_mining": {
        ...
        "icon": "💾",
        "image": "img/collectibles/research_data_mining.webp",
        "use_role": "usable",
        "use_kind": "research_datacore",
    ...
    "research_data_weapons": {
        ...
        "icon": "💾",
        "image": "img/collectibles/research_data_weapons.webp",
        "use_role": "usable",
        "use_kind": "research_datacore",
    ...
    "fleet_nav_chip": {"item_type": "module", "category": "fleet", "rarity": "rare", "name_key": "inv_fleet_nav_chip", "icon": "🧭", "image": "img/collectibles/fleet_nav_chip.webp"},
    "fleet_hyperdrive_module": {"item_type": "module", "category": "fleet", "rarity": "epic", "name_key": "inv_fleet_hyperdrive_module", "icon": "🚀", "image": "img/collectibles/fleet_hyperdrive_module.webp"},
    "fleet_fuel_optimizer": {"item_type": "module", "category": "fleet", "rarity": "rare", "name_key": "inv_fleet_fuel_optimizer", "icon": "⛽"},
    "fleet_computer": {"item_type": "module", "category": "fleet", "rarity": "uncommon", "name_key": "inv_fleet_computer", "icon": "🖥️", "image": "img/collectibles/fleet_computer.webp"},
...
# Attach shared Pass Relic art to build / research / production boosters.
for _key, _spec in ITEM_CATALOG.items():
    if not isinstance(_spec, dict):
        continue
    if _key.startswith("booster_build"):
        _spec.setdefault("image", PASS_BOOSTER_IMAGES["build"])
    elif _key.startswith("booster_research"):
        _spec.setdefault("image", PASS_BOOSTER_IMAGES["research"])
    elif _key.startswith("booster_production"):
        _spec.setdefault("image", PASS_BOOSTER_IMAGES["production"])
...
def container_image_path(item_key: str) -> str:
    ...
    return str(
        ...
        or "img/lootboxes/Generic_Supply_Container.webp"
    )
