...
- **Living Universe (EPIC-26):** Gestaffelte Sessions lassen wenige dormante Menschen-Konten zeitweise aktiv wirken. Gebäude/Forschung nutzen echte Queue-Zeiten; Flottenaktionen laufen nur über kanonische Besitzer (u. a. Expedition/Asteroid), mit echter Hangar-, Slot- und Fuel-Prüfung. Details: [INACTIVE_AUTOPLAY.md](INACTIVE_AUTOPLAY.md).
