...
# Current username validation requires a real player-style name, not the old mevo_ fixture.
if '    uname = f"mevo_{uuid.uuid4().hex[:8]}"\n' in Path("tests/test_mine_evolution.py").read_text(encoding="utf-8"):
    replace_once(
        "tests/test_mine_evolution.py",
