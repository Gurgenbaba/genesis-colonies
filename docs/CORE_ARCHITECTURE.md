...
| Stellar Forge (Shipyard Ascension) | `game/stellar_forge/` | [STELLAR_FORGE.md](STELLAR_FORGE.md) |
...
| Command Initiation (do-first once-through) | `game/initiation/` | [COMMAND_INITIATION.md](COMMAND_INITIATION.md) |
...
| Server Events (timed global LiveOps bonuses) | `game/server_events.py` | [SERVER_EVENTS.md](SERVER_EVENTS.md) |
...
| Provably-fair RNG (HMAC seed commit/reveal) | `game/provably_fair.py` | Shared by Case Battles + Space Lottery |
| Space Lottery / Chrono Chamber (Tombola, Mines, Crash; TK stakes) | `game/space_lottery.py` | [SPACE_LOTTERY.md](SPACE_LOTTERY.md) — Timekeeper debit/credit only |
| Payment Providers (Stripe/PayPal) | `game/payment_providers.py` | [PAYMENT_SHOP.md](PAYMENT_SHOP.md) |
| Creator Promos / Campaign Codes / Commission Ledger | `game/shop_promos.py` | [PAYMENT_SHOP.md](PAYMENT_SHOP.md) (Creator Partner + Campaign) |
