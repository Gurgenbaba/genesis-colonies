  ...
  function bindMailUpdatesControls() {
    ...
    enable.addEventListener("click", async () => {
      ...
      try {
        ...
        setMailUpdatesHint(t("options_mail_updates_confirmation_sent", "Bestätigungs-E-Mail wurde gesendet."), false);
        await refreshMailUpdatesStatus();
      } catch (err) {
        if (!(err && err.name === "AuthError")) {
          setMailUpdatesHint(t("options_mail_updates_unavailable", "E-Mail-Updates sind gerade nicht verfügbar."), true);
        }
      } finally {
    ...
    disable.addEventListener("click", async () => {
      ...
      try {
        ...
        setMailUpdatesHint(t("options_mail_updates_disabled", "E-Mail-Updates wurden deaktiviert."), false);
        await refreshMailUpdatesStatus();
      } catch (err) {
        if (!(err && err.name === "AuthError")) {
          setMailUpdatesHint(t("options_mail_updates_unavailable", "E-Mail-Updates sind gerade nicht verfügbar."), true);
