...
Technische Architektur-Dokumentation (Stand: **v0.5.9.147**, Reality-Sync **2026-08-10**). Ergänzt die [README](../README.md) mit Abläufen, Modulgrenzen und Datenflüssen.
...
**4591 pytest-Tests** (Stand v0.5.9.147 — `python -m pytest --collect-only -q`), u. a.:
