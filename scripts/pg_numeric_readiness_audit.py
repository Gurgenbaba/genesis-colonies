...
POLICIES: tuple[NumericPolicy, ...] = (
    ...
    NumericPolicy("research_queue", "cost_metal", "exact_snapshot", "P0", "research paid cost"),
    NumericPolicy("research_queue", "cost_crystal", "exact_snapshot", "P0", "research paid cost"),
    NumericPolicy("shipyard_queue", "cost_metal", "exact_snapshot", "P0", "shipyard batch paid cost"),
    NumericPolicy("shipyard_queue", "cost_crystal", "exact_snapshot", "P0", "shipyard batch paid cost"),
    NumericPolicy("shipyard_queue", "cost_fuel_cells", "exact_snapshot", "P0", "shipyard batch paid cost"),
    NumericPolicy("defense_queue", "cost_metal", "exact_snapshot", "P0", "defense batch paid cost"),
    NumericPolicy("defense_queue", "cost_crystal", "exact_snapshot", "P0", "defense batch paid cost"),
    NumericPolicy("defense_queue", "cost_fuel_cells", "exact_snapshot", "P0", "defense batch paid cost"),
