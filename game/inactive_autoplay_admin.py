...
from .inactive_autoplay import (
    ...
    INACTIVE_HUMAN_REAL_QUEUE_TIMERS,
...
def build_admin_inactive_autoplay_payload(conn) -> Dict[str, Any]:
    ...
    return {
        ...
        "kpis": {
            ...
            "wait_economy_sec": round(seconds_until_economy_allowed(conn=conn), 1),
        ...
        "config": {
            ...
            "legacy_build_duration_cap": INACTIVE_BUILD_DURATION_CAP,
            "legacy_research_duration_cap": INACTIVE_RESEARCH_DURATION_CAP,
