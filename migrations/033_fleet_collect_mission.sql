-- 033_fleet_collect_mission.sql
-- Allow collect mission type on fleet_movements (SQLite CHECK rebuild).
...
CREATE TABLE IF NOT EXISTS fleet_movements_new (
    ...
    mission_type TEXT NOT NULL CHECK(mission_type IN (
        'transport', 'collect', 'deploy', 'spy', 'attack', 'hold', 'expedition', 'colonize'
    )),
