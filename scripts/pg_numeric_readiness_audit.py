...
POLICIES: tuple[NumericPolicy, ...] = (
    ...
    # Stock / queue amounts.
    NumericPolicy("planet_ships", "amount", "exact_unbounded", "P1", "ship stock"),
    NumericPolicy("shipyard_queue", "amount", "exact_unbounded", "P1", "ship order quantity"),
    NumericPolicy("planet_defense", "amount", "exact_unbounded", "P1", "defense stock"),
    NumericPolicy("defense_queue", "amount", "exact_unbounded", "P0", "defense order quantity"),
    NumericPolicy("planet_troops", "amount", "exact_unbounded", "P0", "troop stock"),
    NumericPolicy("troop_queue", "amount", "exact_unbounded", "P0", "troop order quantity"),

    # Boss/combat/value growth.
    NumericPolicy("world_boss_definitions", "max_hp", "exact_unbounded", "P1", "boss HP definition"),
    NumericPolicy("world_boss_events", "max_hp", "exact_unbounded", "P1", "boss event HP"),
    NumericPolicy("world_boss_events", "current_hp", "exact_unbounded", "P1", "boss event HP"),
    NumericPolicy("world_boss_contributions", "damage", "exact_unbounded", "P1", "boss lifetime event damage"),
    NumericPolicy("pirate_bases", "max_hp", "exact_unbounded", "P1", "pirate boss max HP"),
    NumericPolicy("pirate_bases", "current_hp", "exact_unbounded", "P1", "pirate boss current HP"),
    NumericPolicy("pirate_base_contributions", "damage", "exact_unbounded", "P1", "pirate boss damage"),
    NumericPolicy("combat_hall_of_fame", "attacker_loss_score", "exact_unbounded", "P1", "combat loss value"),
    NumericPolicy("combat_hall_of_fame", "defender_loss_score", "exact_unbounded", "P1", "combat loss value"),
    NumericPolicy("combat_hall_of_fame", "total_destroyed_score", "exact_unbounded", "P1", "combat value"),

    # Imperial Directives / Case Battle values mentioned by the binding audit doc.
    NumericPolicy("player_directives", "target_value", "exact_unbounded", "P1", "directive target"),
    NumericPolicy("player_directives", "progress_value", "exact_unbounded", "P1", "directive progress"),
    NumericPolicy("directive_progress", "delta", "exact_unbounded", "P1", "directive progress event delta"),
    NumericPolicy("case_battles", "total_battle_value", "exact_unbounded", "P1", "case battle aggregate value"),
    NumericPolicy("case_battle_rolls", "reward_amount", "exact_unbounded", "P1", "case battle reward quantity"),
    NumericPolicy("case_battle_rolls", "reward_value", "exact_unbounded", "P1", "case battle reward value"),

    # Existing widened aggregates.
    NumericPolicy("expedition_daily_value", "expo_value_total", "exact_unbounded", "P1", "expedition aggregate"),
    NumericPolicy("expedition_daily_recorded", "expo_value", "exact_unbounded", "P1", "expedition aggregate"),
    NumericPolicy("pirate_intel", "resources_score", "exact_unbounded", "P1", "pirate intel value"),
    NumericPolicy("pirate_intel", "fleet_score", "exact_unbounded", "P1", "pirate intel value"),
    NumericPolicy("pirate_intel", "defense_score", "exact_unbounded", "P1", "pirate intel value"),
    NumericPolicy("chronicle_entries", "score_value", "exact_unbounded", "P1", "chronicle gameplay score/value"),
    NumericPolicy("planet_shipyard_ascension", "hull_mass_progress", "exact_unbounded", "P1", "stellar forge hull-mass progress"),
