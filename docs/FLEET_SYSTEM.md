...
Event keys: `void_scan`, `mineral_deposit`, `fuel_cache`, `debris_salvage`, `nav_interference`, `distress_beacon`, `sensor_glitch`, `ancient_stash`, `pirate_encounter`. Roll ist deterministisch pro `movement_id`. Piratensieg (GC-620G/H): Verluste + optionale Ressourcenbeute; ~30 % Chance auf kleine Schiffbergung (nur leichte/mittlere Hüllen, Score-Cap).
