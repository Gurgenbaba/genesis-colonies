...
│  migration_history + migrations/*.sql (006–122)                   │
└──────────────────────────────────────────────────────────────────┘
```
...
**Aktuelle Migrationen:** `006`–`122` — siehe `migrations/` und `migration_history`.
...
**4162 pytest-Tests** (Stand v0.5.9.58 — `python -m pytest --collect-only -q`), u. a.:
